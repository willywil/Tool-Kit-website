$(document).ready(function(){
    ...
    $("#menu").append("<li id='mna'><a href='../subjects/aerospace.html'>Aerospace</a></li>");
	$("#menu").append("<li id='mna'><a href='../subjects/basics.html'>Basics</a></li>");
	$("#menu").append("<li id='mna'><a href='../subjects/biological.html'>Biological</a></li>");
	$("#menu").append("<li id='mna'><a href='../subjects/chemical.html'>Chemical</a></li>");
	$("#menu").append("<li id='mna'><a href='../subjects/electrical.html'>Electrical</a></li>");
    $("#menu").append("<li id='mna'><a href='../subjects/mechanical.html'>Mechanical</a></li>");
